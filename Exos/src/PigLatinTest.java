...
class PigLatinTest {
    ...
    void pigIt() {
        ...
        assertEquals("arbaBay onnay acitfay hilosophumpay",
                PigLatin.pigIt("Barba non facit philosophum"));
        assertEquals("ctaAay steay abulafay", PigLatin.pigIt("Acta est fabula"));
        assertEquals("ucullusCay onnay acitfay onachummay",
        ...
        assertEquals("uisQay ustodietcay psosiay ustodescay ?",
                PigLatin.pigIt("Quis custodiet ipsos custodes ?"));
        assertEquals("equiescatRay niay acepay",  PigLatin.pigIt("Requiescat in pace"));
        assertEquals("icSay ransittay loriagay undimay",
                PigLatin.pigIt("Sic transit gloria mundi"));
        assertEquals("imeoTay anaosDay teay onaday erentesfay" ,
                PigLatin.pigIt("Timeo Danaos et dona ferentes"));
    ...
    @Test
    void pig() {
        assertEquals("!", PigLatin.pig("!"));
        assertEquals("elloHay", PigLatin.pig("Hello"));
    }
}